...
...in addition to the native search capability, searches could also be triggered by selecting items from a saved Target shopping list, or by scanning barcodes, if you smartphone has that capability.
